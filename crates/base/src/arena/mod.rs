...
//!
//! This crate implements a typed arena and a typeless copy arena.
//!
//! Taken from `rustc_arena`.
use std::{
    alloc::Layout,
    cell::{Cell, RefCell},
    cmp,
...
// nightly feature maybe_uninit_slice
#[inline(always)]
...
impl DroplessArena {
    ...
    pub fn alloc_raw(&self, layout: Layout) -> *mut u8 {
        ...
        loop {
            ...
            unsafe { core::hint::assert_unchecked(end == align_down(end, DROPLESS_ALIGNMENT)) };
...
macro_rules! declare_arena {
    (/* arena lifetime */$l:tt, [$($name:ident: $ty:ty,)*]) => {
        #[derive(Default)]
        pub struct Arena<$l> {
            dropless: $crate::arena::DroplessArena,
            $($name: $crate::arena::TypedArena<$ty>,)*
            _marker: std::marker::PhantomData<&$l ()>,
        }

        pub trait ArenaAllocatable<$l, C = $crate::arena::IsNotCopy>: Sized {
            #[allow(clippy::mut_from_ref)]
            fn allocate_on(self, arena: &$l Arena<$l>) -> &$l mut Self;
        ...
        impl<$l, T: Copy> ArenaAllocatable<$l, $crate::arena::IsCopy> for T {
            #[inline]
            #[allow(clippy::mut_from_ref)]
            fn allocate_on(self, arena: &$l Arena<$l>) -> &$l mut Self {
        ...
        $(
            impl<$l> ArenaAllocatable<$l, $crate::arena::IsNotCopy> for $ty {
                #[inline]
                fn allocate_on(self, arena: &$l Arena<$l>) -> &$l mut Self {
